...
import imagegame2 from "../../assets/game2.png";
import imagegame3 from "../../assets/game3.png";
...
const GamesPage = () => {
  const games = [
    ...
    },
    {
      ...
      description: "Try your luck and test your knowledge of the Indian Constitution with this exciting spin the wheel game.",
      image: imagegame4,
